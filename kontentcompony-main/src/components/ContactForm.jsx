...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwUrmbJFSziB-P-aq7QHj8NIDl5IUrFwyxysz3GCQRu7MxdAu25sslI5Bbu1NhS_QHW/exec';
...
export default function ContactForm() {
    ...
    return (
        <div className="contact-page">
            <Helmet>
                <title>Contact Us | Kontent Company</title>
                <meta name="description" content="Get in touch with Kontent Company for project inquiries. We offer End to End Content Production, 3D VFX, Video Editing, and Website Design." />
                <link rel="canonical" href="https://kontentcompany.in/contact" />
            </Helmet>
